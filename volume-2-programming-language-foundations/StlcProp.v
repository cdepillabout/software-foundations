...
Proof with eauto.
  ...
  - right. inversion Ht; subst.
    specialize (IHt1 <{ T2 -> T }>).
    (* specialize (IHt1 (Ty_Arrow T2 T)). *)
    specialize (IHt2 T2).
    destruct IHt1...
    + destruct IHt2...
      * apply canonical_forms_fun in H2...
        destruct H2 as [x [u HH]]; subst.
        exists <{ [ x := t2 ] u }>...
      * destruct H0.
        exists <{ t1 x0 }>...
  ...
  - right. inversion Ht; subst; clear Ht.
    specialize (IHt1 <{Bool}>). destruct IHt1...
    + apply canonical_forms_bool in H3...
      destruct H3; subst. exists t2... exists t3...
